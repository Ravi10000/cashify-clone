    ...
    <div className="order-item">
      <div className="order-info">
        ...
        <div className="info-container">
          <h2 className="title">
            {title} - refurbish({product.quality})
          </h2>
          <p>
            <div
              className="color"
      ...
      <div className="other-info">
        ...
        <a href="tel:+919667273499">
          <p>
            Call for Support: <span>+919667273499</span>
          </p>
        </a>
        <a href="mailto:mrPhonexCare@gmail.com">
          <p>
            Email Support: <span>mrPhonexCare@gmail.com</span>
          </p>
        </a>
        </div>
      </div>
